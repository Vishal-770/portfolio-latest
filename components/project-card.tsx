...
export function ProjectCard({ title, url, description, tags }: ProjectCardProps) {
  ...
  return (
    <article className="bg-card border border-border/50 rounded-lg p-4 hover:border-border hover:shadow-sm transition-all duration-200 group">
      ...
      <p className="text-sm text-foreground/70 leading-normal mb-3.5 line-clamp-2">{description}</p>
